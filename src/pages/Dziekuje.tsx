      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            <a href="/ebook-download.pdf" download="Jak_Odzyskac_Popoludnia.pdf" className="w-full sm:w-auto bg-lime-400 hover:bg-lime-300 text-slate-950 font-black text-lg md:text-xl px-10 py-6 rounded-2xl shadow-[0_0_40px_-10px_rgba(163,230,53,0.4)] transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3">
