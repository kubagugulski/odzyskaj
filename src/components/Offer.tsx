      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
          ...
          <div className="flex flex-col items-center bg-slate-950 rounded-[2rem] p-8 md:p-10 border border-slate-800 shadow-xl lg:order-2 w-full max-w-md mx-auto">
            ...
            <a 
              href="https://buy.stripe.com/dRmbIUe2p0ajcPs8eWdfG04" 
              onclick="if(window.fbq) fbq('track', 'InitiateCheckout', { content_name: 'Jak odzyskać swoje popołudnia', value: 59.00, currency: 'PLN' });"
              className="w-full bg-lime-400 hover:bg-lime-300 text-slate-950 font-black text-lg md:text-xl px-8 py-6 rounded-2xl shadow-[0_0_40px_-10px_rgba(163,230,53,0.4)] transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 mb-8">
              KUPUJĘ <ArrowRight className="w-6 h-6" />
            </a>
